...
const NavBar = () => {
    ...
    return (
        <nav className="bg-white bg-opacity-5 shadow-nav lg:backdrop-blur-lg py-3 lg:py-0">
            <div className="container max-w-[1240px] flex items-center justify-between">
                ...
                <div className={`${isOpen ? "left-0" : "-left-full"} flex items-center sm:gap-8 md:gap-11 max-lg:flex-col max-lg:fixed max-lg:justify-start max-lg:items-center max-lg:h-full max-lg:w-full max-lg:z-30 max-lg:top-0 max-lg:bg-black max-lg:pt-28 duration-300`}>
                    ...
                    <Cta className='lg:hidden mt-4'>Find More</Cta>
                </div>
